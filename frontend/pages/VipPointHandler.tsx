                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-[30px] p-8 max-w-sm w-full shadow-2xl space-y-8 animate-fade-in text-center border border-slate-100 dark:border-slate-800 overflow-hidden relative">
                        ...
                        <div className="space-y-3">
                            <Button
                                ...
                                className="w-full h-16 bg-[#64748B] hover:bg-[#475569] text-white font-black uppercase tracking-widest rounded-2xl shadow-xl shadow-slate-400/20 text-sm transition-all active:scale-95"
                            >
                                Vincular Agora
                            </Button>
                            <button
                    ...
                    <div className="pt-2">
                        {canRedeem ? (
                            ...
                            <Button
                                ...
                                className="w-full h-16 bg-[#64748B] hover:bg-[#475569] text-white font-black uppercase tracking-widest rounded-2xl text-base shadow-xl shadow-slate-400/20 transition-all active:scale-95"
                            >
            ...
            <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-4 font-sans">
                <div className="bg-white dark:bg-slate-900 rounded-[30px] p-8 max-w-sm w-full shadow-2xl space-y-8 animate-fade-in text-center border border-slate-100 dark:border-slate-800 relative overflow-hidden">
                    ...
                    <div className="pt-2 w-full">
                        <Button
                            onClick={() => window.location.href = '/client'}
                            className="w-full h-14 bg-[#64748B] hover:bg-[#475569] text-white font-black uppercase tracking-widest rounded-2xl text-xs shadow-xl shadow-slate-400/20 transition-all active:scale-95"
                        >
                            Voltar ao Painel
                        </Button>
                    </div>
