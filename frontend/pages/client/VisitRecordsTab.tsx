    ...
    return (
        <div className="space-y-12 animate-in fade-in duration-500 pb-20">
            ...
            <div className="hidden md:flex flex-col gap-8">
                <div>
                    <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight flex items-center gap-3 leading-none">
                    ...
                    <p className="text-lg text-slate-500 dark:text-slate-400 mt-1 font-medium">Histórico completo de interações e pontuações.</p>
                </div>
            </div>
            <div className="flex flex-wrap items-center gap-3">
                    <div className="flex bg-white dark:bg-gray-900 p-1 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm">
                        {['all', 'today', '7days', '30days'].map((p) => (
                            <button
                                key={p}
                                onClick={() => setPeriod(p)}
                                className={`px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${period === p
                    ...
                    <select
                        ...
                        className="h-11 px-4 rounded-lg bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 text-[11px] font-black uppercase tracking-widest text-gray-700 dark:text-gray-300 focus:ring-2 focus:ring-primary-500 transition-all outline-none"
                    >
            ...
            <div className="relative group">
                ...
                <input
                    ...
                    className="w-full h-14 pl-12 pr-4 rounded-lg bg-white dark:bg-gray-900 border-2 border-transparent focus:border-primary-500/20 focus:bg-white dark:focus:bg-gray-900 shadow-sm text-sm font-medium outline-none transition-all group-hover:shadow-md"
                />
            </div>

            {/* Tabela de Visitas */}
            <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden relative">
                <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-800">
                    <table className="w-full text-left border-collapse min-w-[1100px]">
                        <thead>
                            <tr className="bg-gray-50/50 dark:bg-gray-800/50">
                                <th className="px-4 sm:px-6 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest min-w-[250px]">Cliente</th>
                                <th className="px-4 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center min-w-[200px]">Ações</th>
                                <th className="px-3 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center min-w-[150px]">Horário</th>
                                <th className="px-2 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center min-w-[150px]">Origem</th>
                                <th className="px-3 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center min-w-[120px]">Saldo</th>
                            </tr>
                        </thead>
                            ...
                            {isLoading ? (
                                Array(5).fill(0).map((_, i) => (
                                    <tr key={i} className="animate-pulse">
                                        <td colSpan={5} className="px-8 py-6 h-20 bg-gray-50/20 dark:bg-gray-800/10"></td>
                                    </tr>
                                ))
                            ) : visits.length === 0 ? (
                                <tr>
                                    ...
                                    <tr key={v.id} className="group hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors">
                                        ...
                                        <td className="px-4 sm:px-6 py-5">
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 rounded-full overflow-hidden bg-gray-100 dark:bg-gray-800 flex items-center justify-center shadow-inner border border-gray-100 dark:border-gray-800">
                                                    {v.customer_photo_url ? (
                                                        <img src={v.customer_photo_url} alt="" className="w-full h-full object-cover rounded-full" />
                                                    ) : (
                ...
                <div className="px-8 py-6 bg-gray-50/50 dark:bg-gray-800/30 flex items-center justify-between border-t border-gray-100 dark:border-gray-800">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="w-10 h-10 rounded-lg bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 flex items-center justify-center text-gray-600 disabled:opacity-30 disabled:cursor-not-allowed hover:shadow-md transition-all shadow-sm"
                        >
                            <ChevronLeft className="w-5 h-5" />
                        </button>
                        <div className="px-4 h-10 rounded-lg bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 flex items-center justify-center text-[11px] font-black text-gray-900 dark:text-white shadow-sm">
