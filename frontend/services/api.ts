...
export const terminalService = {
    ...
    earn: (slug: string, uid: string | null, phone: string, pin?: string | null, token?: string | null, session_token?: string | null) => uid
        ? api.post(`/public/terminal/${slug}/${uid}/earn`, { phone, pin, token, session_token })
        : api.post(`/public/p/${slug}/earn`, { phone, pin, token, session_token }),
    autoEarn: (slug: string, uid: string) =>
        api.post(`/public/terminal/${slug}/${uid}/auto-earn`),
    redeem: (slug: string, uid: string | null, phone: string, pin?: string | null, token?: string | null, session_token?: string | null) => uid
        ? api.post(`/public/terminal/${slug}/${uid}/redeem`, { phone, pin, token, session_token })
        : api.post(`/public/p/${slug}/redeem`, { phone, pin, token, session_token }),
