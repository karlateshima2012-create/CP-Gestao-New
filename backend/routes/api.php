...
Route::get('/version', function() {
    return response()->json(['version' => '2.5.4', 'time' => now()->toDateTimeString()]);
});
...
Route::get('/serve-file/{path}', [\App\Http\Controllers\PublicTerminalController::class, 'serveFile'])->where('path', '.*');
