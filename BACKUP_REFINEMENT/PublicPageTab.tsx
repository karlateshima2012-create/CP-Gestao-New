      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-8 border-2 border-dashed border-primary-100 dark:border-primary-900/30 bg-white dark:bg-slate-900 flex flex-col justify-between gap-6 rounded-[32px]">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <Button 
                onClick={onCopyLink}
                className={`flex-1 h-12 rounded-2xl font-black uppercase text-[11px] tracking-widest transition-all ${copiedLink ? 'bg-emerald-500 text-white' : 'bg-primary-500 text-white'}`}
              >
        ...
        <Card className="p-8 border-none bg-slate-900 text-white flex flex-col justify-between gap-6 rounded-[32px] overflow-hidden relative">
          ...
          <div className="space-y-4 relative z-10">
            ...
            <Button 
              className="w-full h-14 bg-white text-slate-900 hover:bg-slate-100 rounded-2xl font-black uppercase text-[11px] tracking-widest shadow-xl flex items-center justify-center gap-3"
              onClick={() => {
                // Aqui abriria a rota do totem. Para agora, apenas abrimos o primeiro terminal encontrado
                // ou avisamos que ele deve ir para a aba de Configurações para gerir totens.
