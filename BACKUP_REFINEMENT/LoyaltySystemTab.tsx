...
export const LoyaltySystemTab: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-20 max-w-5xl mx-auto">
      <div>
        <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight">Sistema de Pontos</h1>
        <p className="text-gray-500 dark:text-gray-400 mt-1 text-lg">Defina como seus clientes ganham pontos e sobem de nível.</p>
      </div>
