...
import { LoyaltySystemTab } from './client/LoyaltySystemTab';
import { PublicPageTab } from './client/PublicPageTab';
...
export const ClientCRM: React.FC<ClientCRMProps> = ({ tenantPlan, contacts, setContacts, selectedContact, setSelectedContact, metrics, onRefresh, activeTab, onChangeTab, onTerminalMode, tenantSlug }) => {
  ...
  return (
    <div className="w-full h-full">
      ...
      {activeTab === 'public_page' && <PublicPageTab tenantSlug={tenantSlug} onRefresh={onRefresh} />}
      {activeTab === 'loyalty_system' && <LoyaltySystemTab />}
